...
def main_menu():
    ...
    while True:
        ...
        draw_text(
            "ASTEROID DOS CRIAS", TITLE_FONT_SIZE, TITLE_COLOR, SCREEN_MIDDLE_X, 120
        )
        draw_text(
            "Ento'wn Thouma Productions LTDA",
            FOOTER_FONT_SIZE,
            TEXT_UI_PRIMARY_COLOR,
            SCREEN_MIDDLE_X,
            680,
        )
...
def load_scores_file(file_path):
    ...
    for i, (name, score) in enumerate(scores[:MAX_SCORES_DISPLAY]):
        ...
        draw_text(
            str(score), H4_FONT_SIZE - 5, SCORE_NAME_COLOR, SCREEN_MIDDLE_RIGHT, y
        )
